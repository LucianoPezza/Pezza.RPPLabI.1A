...
{
    int idV;
    idV = getInt("Ingrese el IdVendedor que desee: ", "Error. Ingrese solo numeros: ");
    while(idV > 13 || idV < 10)
    {
        idV = getInt("Ingrese el IdVendedor adecuado Entre 10 y 13: ","Error. Solo ingrese numeros: ");
    }
